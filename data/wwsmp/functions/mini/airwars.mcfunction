...
execute in minecraft:mini_airwars as @a[tag=WWSMP.In.Mini.airwars,scores={wwsmp.mini.airwars.blaster=1..},nbt={SelectedItem:{tag:{wwsmp.mini.airwars.blaster:1}}}] at @s run setblock ~ ~-1 ~ white_wool
...
execute in minecraft:mini_airwars if entity @p[tag=wwsmp.mini.airwars.died] run tellraw @e[type=player,distance=0..,tag=!wwsmp.mini.airwars.died] ["",{"selector":"@p[tag=wwsmp.mini.airwars.died]","color":"dark_green"},{"text":" died!","color":"dark_green"},{"text":" Which means 500 emeralds for you! They'll be stored in your BertBanking account!","color":"yellow"},{"text":"\n\n"},{"text":"Times ","color":"gold"},{"selector":"@p[tag=wwsmp.mini.airwars.died]","color":"gold"},{"text":" died:","color":"gold"},{"text":" "},{"score":{"name":"@p[tag=wwsmp.mini.airwars.died]","objective":"wwsmp.mini.airwars.deaths"},"color":"dark_blue"}]
execute in minecraft:mini_airwars if entity @p[tag=wwsmp.mini.airwars.died] run scoreboard players add @e[distance=0..,tag=!wwsmp.mini.airwars.died] Berts_Banking_Credit 500
execute in minecraft:mini_airwars if entity @p[tag=wwsmp.mini.airwars.died] run tellraw @p[tag=wwsmp.mini.airwars.died] ["",{"text":"You died.","color":"red"},{"text":" That'll cost you 300 emeralds, withdrawn from your BertBanking account.","color":"yellow"},{"text":"\n\n"},{"text":"F for you.","color":"gray"},{"text":"\n\n"},{"text":"Times you died:","color":"gold"},{"text":" "},{"score":{"name":"@p[tag=wwsmp.mini.airwars.died]","objective":"wwsmp.mini.airwars.deaths"},"color":"dark_blue"}]
execute in minecraft:mini_airwars if entity @p[tag=wwsmp.mini.airwars.died] run scoreboard players remove @p[tag=wwsmp.mini.airwars.died] Berts_Banking_Credit 300
tag @a remove wwsmp.mini.airwars.died

execute in minecraft:mini_airwars if block 0 65 0 air run function wwsmp:airwarsautoreset/load
