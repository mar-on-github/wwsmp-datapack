...
item replace entity MelonOnMain armor.head with golden_helmet{display:{Name:'[{"text":"Crown","italic":false,"color":"gold"},{"text":" of Mar","color":"red"}]',Lore:['[{"text":"Crown for the Queen of Witches only.","italic":false}]']},Enchantments:[{id:aqua_affinity,lvl:1},{id:binding_curse,lvl:1},{id:vanishing_curse,lvl:1},{id:fire_protection,lvl:4},{id:projectile_protection,lvl:10},{id:respiration,lvl:10},{id:thorns,lvl:15},{id:unbreaking,lvl:10}],HideFlags:1} 1