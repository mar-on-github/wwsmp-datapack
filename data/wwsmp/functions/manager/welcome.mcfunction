...
tellraw @a[tag=!Welcomed] ["",{"text":"A Dynamic map of this server can be browsed ","color":"yellow"},{"text":"here","color":"blue","clickEvent":{"action":"open_url","value":"http://wwsmp.from-mar.com:8100/"}},{"text":".","color":"yellow"}]
